            ...
            <div class="card-body">                
                ...
                <div class="row form-group mb-3">
                    ...
                    <select
                        ...
                        <option value="<?= $item->id ?>" <?= set_select('kategori[]', $item->id); ?>><?= $item->nama ?></option>
                        <?php } ?>                        
                    </select>
                ...
                <div class="form-group mb-3">
                    ...
                    <div class="col-md-12">
                        <textarea style="height: 100px" id="editor" name="deskripsi" class="form-control" placeholder="Masukkan deskripsi " id=""><?= set_value('deskripsi'); ?></textarea>                        
